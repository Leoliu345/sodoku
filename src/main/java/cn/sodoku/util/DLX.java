...
public class DLX {
    ...
    public static boolean hasSolve(int[][] data){
        DLX dlx = new DLX(9 * 9 * 9 + 1, 4 * 9 * 9);
        if(dlx.solve(data)) return false;//System.out.println("有多个解");
        List<int[][]> solutions = dlx.getSolutions();//System.out.println("无解");
